  ...
  return (
    <section id="hero" className="relative min-h-[92vh] flex items-center justify-center overflow-hidden pt-12 pb-20">
      ...
      <div className="absolute inset-0 z-0">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-[#000000] via-[#000000]/75 to-white/40" />
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center pt-8">
        ...
        <motion.div
          ...
          className="inline-flex flex-wrap items-center justify-center gap-1.5 sm:gap-2 px-3 py-1.5 sm:px-4 sm:py-2 rounded-full bg-slate-100/80 border border-rose-500/30 backdrop-blur-md mb-6 shadow-[0_0_20px_rgba(227,0,79,0.2)] max-w-full"
        >
        ...
        <motion.h1
          ...
          className="text-3xl xs:text-4xl sm:text-6xl md:text-7xl lg:text-8xl font-display font-bold tracking-tight text-zinc-900 leading-[1.08] mb-4 sm:mb-6 max-w-5xl mx-auto break-words"
        >
        ...
        <motion.p
          ...
          className="text-sm sm:text-lg md:text-xl text-slate-700 font-normal max-w-3xl mx-auto leading-relaxed mb-8 sm:mb-10 px-2"
        >
          {currentLang === 'es'
        ...
        >
          ...
          >
            <div className="w-6 h-6 sm:w-7 sm:h-7 rounded-full bg-white/20 flex items-center justify-center group-hover:scale-110 transition-transform shrink-0">
              <WhatsAppIcon className="w-4 h-4 sm:w-5 sm:h-5 text-zinc-900 fill-current" />
            </div>
            <span className="whitespace-nowrap">
              {currentLang === 'es' ? 'Cotizar Pedido por WhatsApp' : 'Request Order via WhatsApp'}
            </span>
            <ArrowRight className="w-4 h-4 sm:w-5 sm:h-5 text-zinc-900 group-hover:translate-x-1 transition-transform shrink-0" />
          </a>

          {/* Secondary Catalog Button */}
          <a
            href="#catalogo"
            className="w-full sm:w-auto inline-flex items-center justify-center gap-2 bg-slate-100/80 hover:bg-slate-200 text-slate-800 border border-slate-700/80 hover:border-rose-500/50 font-semibold text-sm sm:text-base px-6 sm:px-7 py-3.5 sm:py-4 rounded-full backdrop-blur-md transition-all transform hover:-translate-y-0.5"
          >
        ...
        <motion.div
          ...
          className="flex flex-wrap items-center justify-center gap-y-2 gap-x-4 sm:gap-x-6 text-xs sm:text-sm text-slate-600 font-medium mb-12 sm:mb-16 px-2"
        >
        ...
        >
          <div className="glass-card p-3.5 sm:p-5 rounded-2xl text-center border-t-2 border-t-[#E3004F]">
            <span className="block font-display font-bold text-xl sm:text-3xl md:text-4xl text-zinc-900 mb-1">
              2,800m
            </span>
            <span className="text-[11px] sm:text-sm text-slate-600 font-medium">
